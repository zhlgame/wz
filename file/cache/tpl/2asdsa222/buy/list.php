...
<?php } } ?>
        ...
        <div class="container fl">
            ...
            <?php if($tags) { ?><?php include template('buylist', 'tag');?><?php } ?>
            </div>
...
<?php echo tag("moduleid=6&length=20&condition=status=3 and thumb<>''&pagesize=5&order=edittime desc&width=160&height=160&cols=8&template=pro");?> 
            </div>
        </div>
        <div class="sideBar fr">
            ...
            <div class="recommend box01 mt-15">
                ...
                <?php echo tag("moduleid=$searchid&table=keyword&condition=moduleid=$searchid and status=3&pagesize=10&order=total_search desc&template=520hot_kw");?>
            </div>
             <!--本周搜索排行-->
  <div class="recommend box01 mt-15">
                <div class="header"><h3>本周搜索排行</h3></div>
                <ul class="black">
<?php echo tag("moduleid=$moduleid&table=keyword&condition=moduleid=$moduleid and status=3 and updatetime>$today_endtime-86400*7&pagesize=10&order=week_search desc&key=week_search&template=ss2222");?>
                </ul>       
            </div>
            <div class="clear">
            </div>
