...
<div class="list-set" onclick="$('#tips-top').fadeToggle('fast');">
<ul>
<li><div style="border:none;"><b>滚动与刷新</b></div></li>
</div>
<div class="main" id="tips-top">
<div class="tips">
轻按页面标题，页面会自动滚动到顶部<br/>
按住页面标题，页面会自动刷新<br/>
<img src="static/img/tips-top.png"/><br/>
</div>
</div>
<?php if($DT_MOB['os'] == 'ios' && $DT_MOB['browser'] == 'safari') { ?>
<div class="blank-35"></div>
<div class="list-set" onclick="$('#tips-screen').fadeToggle('fast');">
<ul>
<li><div style="border:none;"><b>添加到主屏幕</b></div></li>
</div>
<div class="main" id="tips-screen">
<div class="tips">
返回首页，轻按浏览器添加图标<br/>
<img src="static/img/tips-screen-ios-1.png"/><br/>
在弹出的菜单中选择添加到主屏幕<br/>
<img src="static/img/tips-screen-ios-2.png"/><br/>
...
<?php } ?>
<div class="blank-35"></div>
<div class="list-set" onclick="$('#tips-set').fadeToggle('fast');">
<ul>
<li><div style="border:none;"><b>偏好设置</b></div></li>
</div>
<div class="main" id="tips-set">
<div class="tips">
轻按首页右上角设置图标进入偏好设置<br/>
<img src="static/img/tips-setting.png"/><br/>
可根据自己兴趣对首页加载的频道进行排序和删除操作<br/>
</div>
</div>
<div class="blank-35"></div>
<div class="list-set" onclick="$('#tips-load').fadeToggle('fast');">
<ul>
<li><div style="border:none;"><b>加载超时</b></div></li>
</div>
<div class="main" id="tips-load">
<div class="tips">
由于网络或者其他未知原因导致加载超时<br/>
<img src="static/img/tips-load.png"/><br/>
轻按转动的加载图标可以刷新当前页面并重新加载<br/>
</div>
</div>
<?php if(DT_DEBUG) { ?>
<div class="blank-35"></div>
<div class="list-set" onclick="$('#tips-os').fadeToggle('fast');">
<ul>
<li><div style="border:none;"><b>客户端信息</b></div></li>
</div>
