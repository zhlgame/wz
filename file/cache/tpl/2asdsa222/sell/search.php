...
当前位置: <a href="<?php echo $MODULE['1']['linkurl'];?>">首页</a> » <a href="<?php echo $MOD['linkurl'];?>"><?php echo $MOD['name'];?></a> » 搜索</div>
        <!--分类-->
...
<?php } } ?>
                    ...
                    <div class="prices hoverSelf buy fr">
                        <div class="inner">
                            <ul class="clearfix">
                                <li class="item">
        ...
        <div class="container fl">
            ...
            <?php if($tags) { ?><?php include template('selllist', 'tag');?><?php } else { ?> 
