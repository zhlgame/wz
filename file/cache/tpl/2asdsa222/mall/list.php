...
<div id="main" class="full">
    <div class="wrap">
        <div class="crumbs"> <span class="fr mr-10">共找到 <b class="red"><?php echo $items;?></b> 条<strong class="red"> <?php echo $CAT['catname'];?> </strong> 产品信息</span> 
 
 
当前位置: <a href="<?php echo $MODULE['1']['linkurl'];?>">首页</a> » <a href="<?php echo $MOD['linkurl'];?>"><?php echo $MOD['name'];?></a> » <?php echo cat_pos($CAT, ' » ');?></div>
        <!--分类-->
        <div class="category cldl mt-10">
            <dl>
                ...
                <li <?php if($k>$MOD['page_subcat']) { ?> class="hide"<?php } ?>
><a <?php if($v['catid']==$catnow) { ?> class="active"<?php } ?>
 href="<?php echo $MOD['linkurl'];?><?php echo $v['linkurl'];?>"><?php echo $v['catname'];?></a></li>
                <?php } } ?>
            </ul>
            <?php if($k > $MOD['page_subcat']) { ?><a href="JavaScript:" class="category-showmorebtn"><em>展开</em></a><?php } ?>
...
<?php } } ?>
        ...
        <div class="container fl">
            ...
            <?php if($tags) { ?><?php include template('1314', 'tag');?><?php } ?>
            </div>
            <div class="box01 top-reconmmend">
                <div class="header"> <a class="more" target="_blank" href="#"> 我也要出现在这里</a>
                    <h3>热门推荐</h3>
                </div>
<?php echo tag("moduleid=$moduleid&length=20&condition=status=3 and thumb<>''&pagesize=5&order=edittime desc&width=160&height=160&cols=8&template=xyun555");?> 
            </div>
        </div>
        <div class="sideBar fr">
            ...
            <div class="recommend box01 mt-15">
                ...
                <?php echo tag("moduleid=$searchid&table=keyword&condition=moduleid=$searchid and status=3&pagesize=10&order=total_search desc&template=xiaoyun5555");?>
            </div>
            <div class="mt-15">
                <?php echo ad(68);?>
            </div>
