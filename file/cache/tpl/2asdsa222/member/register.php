...
<style type="text/css">
.tl{width:60px;text-align:right;padding-right:10px;background:#FFFFFF;}
.reg_title {border-bottom:#CCCCCC 1px solid;font-weight:bold;padding:0 0 10px 10px;margin:15px 55px 0 0;font-size:14px;color:#FF6600;}
.reg_inp {border:#B2B2B2 1px solid;padding:3px 0 3px 0;}
...
$('.head-bar-right').html('<a href="<?php echo $EXT['mobile_url'];?>login.php"><span>登录</span></a>');
</script>
<?php } else { ?>
