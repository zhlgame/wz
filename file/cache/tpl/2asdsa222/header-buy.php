...
>
        ...
        <li class="mod_cate">
            <span class="icon icon1"><a href="http://www.mjuq.com/buy/list.php?catid=1" >蔬菜杂粮</a></span>
                <div class="mod_subcate clearfix">
                    <div class="mod_subcate_main fl">
                    <?php $catid=415;$cols=6;$level=1?>
                    <?php include template('buy', 'chip');?>
                    </div>
...
<li><a href="" target="_blank"><img src="<?php echo DT_SKIN;?>bd/18.jpg"></a></li>
            ...
            <li class="mod_cate">
            <span class="icon icon2"><a href="http://www.mjuq.com/buy/list.php?catid=1" >新鲜水果</a></span>
            <div class="mod_subcate clearfix">
                    <div class="mod_subcate_main fl">
...
<li><a href="" target="_blank"><img src="<?php echo DT_SKIN;?>bd/18.jpg"></a></li>
            ...
            <li class="mod_cate">
            <span class="icon icon3"><a href="http://www.mjuq.com/buy/list.php?catid=1" >种植、培育</a></span>
                <div class="mod_subcate clearfix">
                    <div class="mod_subcate_main fl">
...
<li><a href="" target="_blank"><img src="<?php echo DT_SKIN;?>bd/18.jpg"></a></li>
            ...
            <li class="mod_cate">
            <span class="icon icon4"><a href="http://www.mjuq.com/buy/list.php?catid=1" >畜牧养殖</a></span>
                <div class="mod_subcate clearfix">
                    <div class="mod_subcate_main fl">
...
<li><a href="" target="_blank"><img src="<?php echo DT_SKIN;?>bd/18.jpg"></a></li>
            ...
            <li class="mod_cate">
            <span class="icon icon5"><a href="http://www.mjuq.com/buy/list.php?catid=1" >渔业水产</a></span>
                <div class="mod_subcate clearfix">
                    <div class="mod_subcate_main fl">
...
<li><a href="" target="_blank"><img src="<?php echo DT_SKIN;?>bd/18.jpg"></a></li>
            ...
            <li class="mod_cate">
            <span class="icon icon6"><a href="http://www.mjuq.com/buy/list.php?catid=1" >山珍药材</a></span>
                <div class="mod_subcate clearfix">
                    <div class="mod_subcate_main fl">
...
<li><a href="" target="_blank"><img src="<?php echo DT_SKIN;?>bd/18.jpg"></a></li>
            ...
            <li class="mod_cate">
            <span class="icon icon7"><a href="http://www.mjuq.com/buy/list.php?catid=1" >苗草花木</a></span>
                <div class="mod_subcate clearfix">
                    <div class="mod_subcate_main fl">
...
<li class="mod_cate">
            <span class="icon icon8"><a href="http://www.mjuq.com/buy/list.php?catid=1" >农机耕具</a></span>
                <div class="mod_subcate clearfix">
                    <div class="mod_subcate_main fl">
...
<li><a href="" target="_blank"><img src="<?php echo DT_SKIN;?>bd/18.jpg"></a></li>
            ...
            <li class="mod_cate">
            <span class="icon icon9"><a href="http://www.mjuq.com/buy/list.php?catid=1" >农资、化肥</a></span>
                <div class="mod_subcate clearfix">
                    <div class="mod_subcate_main fl">
...
<li><a href="" target="_blank"><img src="<?php echo DT_SKIN;?>bd/18.jpg"></a></li>
            ...
            <li class="mod_cate">
            <span class="icon icon10"><a href="http://www.mjuq.com/buy/list.php?catid=1" >资源、食品</a></span>
                <div class="mod_subcate clearfix">
                    <div class="mod_subcate_main fl">
